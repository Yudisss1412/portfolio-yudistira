  ...
  const projects = [
    ...
    },
    {
      ...
      mockups: [
        {
          title: 'Intro Page',
          description: 'Landing page dengan navigasi dan call-to-action.',
          image: 'Intro.png',
          color: 'from-purple-400 to-indigo-500',
        },
        {
          title: 'Login Page',
          description: 'Halaman login dengan autentikasi Google dan Facebook.',
          image: 'Login.png',
          color: 'from-indigo-400 to-blue-500',
        },
        {
          title: 'Create Account',
          description: 'Form registrasi untuk pengguna baru.',
        ...
        {
          title: 'About Us',
          description: 'Halaman informasi tentang project dan tim.',
          image: 'About Us.png',
          color: 'from-teal-400 to-green-500',
        },
      ],
    ...
    },
    {
      ...
      mockups: [
        {
          title: 'Homepage',
          description: 'Halaman depan galeri dengan 3D Carousel interaktif dan splash loader.',
          image: 'galeri-seni-home.png',
          color: 'from-neutral-800 to-neutral-950',
        },
        {
          title: 'Virtual Gallery',
          description: 'Halaman katalog yang menampilkan seluruh koleksi karya seni yang dikurasi.',
          image: 'galeri-seni-gallery.png',
          color: 'from-neutral-700 to-neutral-900',
        },
        {
          title: 'Artwork Detail & Audio Guide',
          description: 'Halaman detail lukisan lengkap dengan kontrol pemutar audio penjelasan filosofi karya.',
          image: 'galeri-seni-detail.png',
          color: 'from-zinc-800 to-neutral-950',
        },
        {
          title: 'Art Journal',
          description: 'Kumpulan artikel, catatan, dan ulasan perkembangan seni kontemporer.',
          image: 'galeri-seni-journal.png',
          color: 'from-zinc-700 to-zinc-900',
        },
        {
          title: 'Online Viewing Room (OVR)',
          description: 'Ruang pameran virtual khusus untuk menikmati pameran eksklusif secara online.',
    ...
    },
    {
      ...
      mockups: [
        {
          title: 'Homepage',
          description: 'Landing page utama yang menjelaskan ekosistem integrasi HR, Akuntansi, dan Operasional.',
          image: 'serangkai-home.png',
          color: 'from-indigo-600 to-violet-700',
        },
        {
          title: 'ERP Modules & Products',
          description: 'Detail modul utama seperti Serangkai Talenta, Jurnal, dan Kelola.',
          image: 'serangkai-produk.png',
          color: 'from-violet-600 to-fuchsia-700',
        },
        {
          title: 'Pricing & Plans',
          description: 'Halaman paket harga langganan interaktif yang disesuaikan dengan skala bisnis.',
          image: 'serangkai-harga.png',
          color: 'from-fuchsia-600 to-purple-700',
        },
        {
          title: 'Business Solutions',
          description: 'Solusi operasional terarah untuk UMKM, Bisnis Berkembang, dan Enterprise.',
          image: 'serangkai-solusi.png',
          color: 'from-indigo-700 to-indigo-900',
        },
        {
          title: 'Resource Center & Insights',
          description: 'Pusat bantuan, dokumentasi API, dan artikel edukasi/wawasan bisnis.',
